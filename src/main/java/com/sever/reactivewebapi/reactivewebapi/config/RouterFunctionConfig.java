...
public class RouterFunctionConfig {
    ...
    public static final String EMPLOYEE_V1 = "employee/v1";
    public static final String EMPLOYEES_V1_ID = EMPLOYEE_V1 + "/{id}";
    @Bean
    public RouterFunction<ServerResponse> routes(EmployeeEntityHandler employeeController) {
        return route(GET(EMPLOYEE_V1), employeeController::all)
                .andRoute(POST(EMPLOYEE_V1), employeeController::create)
